...
namespace SportsManagementAPi.Security
{
    public class TokenHandler : ITokenHandler
    {
        ...
        public AccessToken CreateAccessToken(Manager user)
        {
        ...
        private AccessToken BuildAccessToken(Manager user, RefreshToken refreshToken)
        {
        ...
        private IEnumerable<Claim> GetClaims(Manager user)
        {
